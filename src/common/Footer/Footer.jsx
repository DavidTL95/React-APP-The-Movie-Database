  ...
  return (
    <Container fluid className='contenedorFooter' xs={12} md={12} xl={12}>
        <div className='contenedorRRSS'>
            <a href="" target='_blank'><img src="footer/common/src/public/img/RRSS/facebook.png" alt="facebook"/></a>
            <a href="" target='_blank'><img src="src/public/img/RRSS/instagram.png" alt="instagram"/></a>
